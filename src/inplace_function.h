...
template<typename R, typename... Args>
struct EmptyTable {
    static vtable<R, Args...> empty_vtable{};
};
...
public:
    ...
    inplace_function() noexcept :
        vtable_ptr_{std::addressof(inplace_function_detail::EmptyTable<R, Args...>::empty_vtable)}
    {}
    ...
    {
        return vtable_ptr_ != std::addressof(inplace_function_detail::EmptyTable<R, Args...>::empty_vtable);
    }
