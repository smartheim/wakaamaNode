...
lwm2m_object_t* init_security_object(void);
lwm2m_object_t* init_server_object(lwm2m_context_t *contextP);
lwm2m_object_t* init_device_object(void);
 ...
 */
security_instance_t* lwm2m_get_security_object(uint16_t security_instance_id);
