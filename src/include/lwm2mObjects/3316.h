...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef ResetMinandMaxMeasuredValues3316
    class ResetMinandMaxMeasuredValuesType : public Opaque<30> {};
    #endif
    
    #ifndef CurrentCalibration3316
    class CurrentCalibrationType : public PreallocString<30> {};
    #endif
    
    #ifndef ApplicationType3316
    class ApplicationTypeType : public PreallocString<30> {};
    #endif
    

/* \brief Class for object 3316 - Voltage
 *  This IPSO object should be used with voltmeter sensor to report measured voltage between
 *  two points. It also provides resources for minimum and maximum measured values, as
 *  well as the minimum and maximum range that can be measured by the sensor. An example measurement
 *  unit is volts (ucum: V).
 */
 ...
 *  unit is volts (ucum: V).
 */
class object : public Lwm2mObject<3316, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3316::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3316::RESID c1) { return (uint16_t) c1 == c2; }
