 ...
 *  the minimum/maximum range that can be measured by the humidity sensor. An example measurement
 *  unit is relative humidity as a percentage (ucum:%).
 */
 ...
 *  unit is relative humidity as a percentage (ucum:%).
 */
class object : public Lwm2mObject<3304, object, instance> {
public:
