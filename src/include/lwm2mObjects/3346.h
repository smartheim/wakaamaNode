 ...
 *  and maximum measured values, as well as the minimum and maximum range that can be measured
 *  by the sensor.An example measurement unit is Feet per Second (ucum:ft_us/s).
 */
...
public:
    ...
    // Optional resource
    // 5701 - Measurement Units Definition e.g. Rate, example units = Feet per Second
    float SensorUnits;
 ...
 *  by the sensor.An example measurement unit is Feet per Second (ucum:ft_us/s).
 */
class object : public Lwm2mObject<3346, object, instance> {
public:
