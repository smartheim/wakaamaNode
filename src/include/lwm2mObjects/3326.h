...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef ResetMinandMaxMeasuredValues3326
    class ResetMinandMaxMeasuredValuesType : public Opaque<30> {};
    #endif
    
    #ifndef CurrentCalibration3326
    class CurrentCalibrationType : public PreallocString<30> {};
    #endif
    
    #ifndef ApplicationType3326
    class ApplicationTypeType : public PreallocString<30> {};
    #endif
    

/* \brief Class for object 3326 - Acidity
 *  This IPSO object should be used to report an acidity measurement of a liquid. It also
 ...
 *  pH.
 */
class object : public Lwm2mObject<3326, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3326::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3326::RESID c1) { return (uint16_t) c1 == c2; }
