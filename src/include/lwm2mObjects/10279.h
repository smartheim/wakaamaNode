 ...
 *  clear threshold, the alarm should be cleared
 */
class object : public Lwm2mObject<10279, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10279::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10279::RESID c1) { return (uint16_t) c1 == c2; }
