...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef LatestDeliveredEventTime10272
    class LatestDeliveredEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestRecordedEventTime10272
    class LatestRecordedEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestPayload10272
    class LatestPayloadType : public Opaque<30> {};
    #endif
    

/* \brief Class for object 10272 - Water Meter Customer Leakage Alarm
 *  A binary flag indicating continual usage (e.g. greater than 5 L/h for 24 hours and the
 *  flow never returning to zero at any time).
 */
 ...
 *  flow never returning to zero at any time).
 */
class object : public Lwm2mObject<10272, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10272::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10272::RESID c1) { return (uint16_t) c1 == c2; }
