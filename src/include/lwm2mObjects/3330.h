...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef ResetMinandMaxMeasuredValues3330
    class ResetMinandMaxMeasuredValuesType : public Opaque<30> {};
    #endif
    
    #ifndef CurrentCalibration3330
    class CurrentCalibrationType : public PreallocString<30> {};
    #endif
    
    #ifndef ApplicationType3330
    class ApplicationTypeType : public PreallocString<30> {};
    #endif
    

/* \brief Class for object 3330 - Distance
 *  This IPSO object should be used to report a distance measurement. It also provides resources
 *  for minimum and maximum measured values, as well as the minimum and maximum range that
 *  can be measured by the sensor. An example measurement unit is Meters (ucum: m).
 */
 ...
 *  can be measured by the sensor. An example measurement unit is Meters (ucum: m).
 */
class object : public Lwm2mObject<3330, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3330::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3330::RESID c1) { return (uint16_t) c1 == c2; }
