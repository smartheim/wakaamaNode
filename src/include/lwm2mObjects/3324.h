...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef ResetMinandMaxMeasuredValues3324
    class ResetMinandMaxMeasuredValuesType : public Opaque<30> {};
    #endif
    
    #ifndef CurrentCalibration3324
    class CurrentCalibrationType : public PreallocString<30> {};
    #endif
    
    #ifndef ApplicationType3324
    class ApplicationTypeType : public PreallocString<30> {};
    #endif
    

/* \brief Class for object 3324 - Loudness
 *  This IPSO object should be used to report loudness or noise level measurements. It also
 *  provides resources for minimum and maximum measured values, as well as the minimum
 ...
 *  decibels (ucum: dB).
 */
class object : public Lwm2mObject<3324, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3324::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3324::RESID c1) { return (uint16_t) c1 == c2; }
