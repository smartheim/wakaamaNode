 ...
 *  pressure below a pre-configured threshold.
 */
class object : public Lwm2mObject<10277, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10277::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10277::RESID c1) { return (uint16_t) c1 == c2; }
