...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef ResetMinandMaxMeasuredValues3322
    class ResetMinandMaxMeasuredValuesType : public Opaque<30> {};
    #endif
    
    #ifndef CurrentCalibration3322
    class CurrentCalibrationType : public PreallocString<30> {};
    #endif
    
    #ifndef ApplicationType3322
    class ApplicationTypeType : public PreallocString<30> {};
    #endif
    

/* \brief Class for object 3322 - Load
 *  This IPSO object should be used with a load sensor (as in a scale) to report the applied
 *  weight or force. It also provides resources for minimum and maximum measured values,
 *  as well as the minimum and maximum range that can be measured by the sensor. An example
 ...
 *  measurement unit is kilograms (ucum: Kg).
 */
class object : public Lwm2mObject<3322, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3322::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3322::RESID c1) { return (uint16_t) c1 == c2; }
