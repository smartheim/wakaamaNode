 ...
 *  This Alarm is raised when the battery voltage drops below a defined level
 */
class object : public Lwm2mObject<10281, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10281::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10281::RESID c1) { return (uint16_t) c1 == c2; }
