...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef ResetMinandMaxMeasuredValues3317
    class ResetMinandMaxMeasuredValuesType : public Opaque<30> {};
    #endif
    
    #ifndef CurrentCalibration3317
    class CurrentCalibrationType : public PreallocString<30> {};
    #endif
    
    #ifndef ApplicationType3317
    class ApplicationTypeType : public PreallocString<30> {};
    #endif
    

/* \brief Class for object 3317 - Current
 *  This IPSO object should be used with an ammeter to report measured electric current
 *  in amperes. It also provides resources for minimum and maximum measured values, as
 *  well as the minimum and maximum range that can be measured by the sensor. An example measurement
 *  unit is volts (ucum: A).
 */
 ...
 *  unit is volts (ucum: A).
 */
class object : public Lwm2mObject<3317, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3317::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3317::RESID c1) { return (uint16_t) c1 == c2; }
