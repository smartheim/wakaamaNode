...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef LatestDeliveredEventTime10280
    class LatestDeliveredEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestRecordedEventTime10280
    class LatestRecordedEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestPayload10280
    class LatestPayloadType : public Opaque<30> {};
    #endif
    

/* \brief Class for object 10280 - Water Network Leak Alarm
 *  All meters must support the following default configuration. This alarm will be based
 *  on the frequency output of the vibration sensor/accelerometer on the SEW Daughter
 *  board. When a frequency is identified that has the characteristics of an upstream network
 *  leak, and its amplitude is above the defined threshold, the meter will report this as
 *  a network leak alarm.
 */
 ...
 *  a network leak alarm.
 */
class object : public Lwm2mObject<10280, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10280::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10280::RESID c1) { return (uint16_t) c1 == c2; }
