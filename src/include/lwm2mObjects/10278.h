...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef LatestDeliveredEventTime10278
    class LatestDeliveredEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestRecordedEventTime10278
    class LatestRecordedEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestPayload10278
    class LatestPayloadType : public Opaque<30> {};
    #endif
    

/* \brief Class for object 10278 - High Temperature Alarm
 *  Where supported by the meter this is an alarm that should be raised if the meter detects
 *  temperature above a pre-configured threshold. When the temperature drops below the
 *  clear threshold, the alarm should be cleared.
 */
 ...
 *  clear threshold, the alarm should be cleared.
 */
class object : public Lwm2mObject<10278, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10278::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10278::RESID c1) { return (uint16_t) c1 == c2; }
