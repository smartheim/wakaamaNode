 ...
 *  An alarm when meter detects there is no liquid in the pipe
 */
class object : public Lwm2mObject<10274, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10274::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10274::RESID c1) { return (uint16_t) c1 == c2; }
