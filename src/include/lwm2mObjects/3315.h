...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef SensorUnits3315
    class SensorUnitsType : public PreallocString<30> {};
    #endif
    
    #ifndef ResetMinandMaxMeasuredValues3315
...
inline bool operator== (KnownObjects::id3315::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3315::RESID c1) { return (uint16_t) c1 == c2; }
