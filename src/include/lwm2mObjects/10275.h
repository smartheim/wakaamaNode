...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef LatestDeliveredEventTime10275
    class LatestDeliveredEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestRecordedEventTime10275
    class LatestRecordedEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestPayload10275
    class LatestPayloadType : public Opaque<30> {};
    #endif
    

/* \brief Class for object 10275 - Water Meter Tamper Alarm
 *  Detects interference from strong magnetic field or other electrical sources. If this
 *  is not relevant for ultrasonic meters then the tamper alarm may be used to indicate someone
 *  attempting to open the physical enclosure or other options the manufacturer may present.
 */
 ...
 *  attempting to open the physical enclosure or other options the manufacturer may present.
 */
class object : public Lwm2mObject<10275, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10275::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10275::RESID c1) { return (uint16_t) c1 == c2; }
