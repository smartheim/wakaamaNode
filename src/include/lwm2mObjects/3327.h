 ...
 *  measurement unit is Siemens (ucum: S).
 */
class object : public Lwm2mObject<3327, object, instance> {
public:
...
inline bool operator== (KnownObjects::id3327::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id3327::RESID c1) { return (uint16_t) c1 == c2; }
