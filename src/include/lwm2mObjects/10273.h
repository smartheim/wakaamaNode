...
// Custom, overrideable types for Opaque and String resources
    ...
    #ifndef LatestDeliveredEventTime10273
    class LatestDeliveredEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestRecordedEventTime10273
    class LatestRecordedEventTimeType : public PreallocString<30> {};
    #endif
    
    #ifndef LatestPayload10273
    class LatestPayloadType : public Opaque<30> {};
    #endif
    

/* \brief Class for object 10273 - Water Meter Reverse Flow Alarm
 *  An alarm indicating reverse flow through the pipe. Also supports delivery of the approximate
 *  volume of water flowing in the reverse direction in the preceding period.
 */
 ...
 *  volume of water flowing in the reverse direction in the preceding period.
 */
class object : public Lwm2mObject<10273, object, instance> {
public:
...
inline bool operator== (KnownObjects::id10273::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, KnownObjects::id10273::RESID c1) { return (uint16_t) c1 == c2; }
