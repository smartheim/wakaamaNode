...
namespace id10271 {
/* \brief Class for object 10271 - Communications Activity Time Readings
 *  Measures the total duration that the meter was activating its radio for packet transmission
 *  or receipt for the period. Used to monitor for excess poower usage over time.
 */
...
public:
    ...
    PreallocString<30> IntervalUTCOffset;
    ...
    PreallocString<30> IntervalCollectionStartTime; // Time
    ...
    PreallocString<30> OldestRecordedInterval; // Time
    ...
    PreallocString<30> LastDeliveredInterval; // Time
    ...
    PreallocString<30> LatestRecordedInterval; // Time
    ...
    Opaque<30> IntervalHistoricalReadPayload;
 ...
 *  or receipt for the period. Used to monitor for excess poower usage over time.
 */
class object : public Lwm2mObject<10271, object, instance> {
public:
...
inline bool operator== (id10271::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id10271::instance::RESID c1) { return (uint16_t) c1 == c2; }
