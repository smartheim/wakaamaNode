...
namespace id10269 {
/* \brief Class for object 10269 - Pressure Readings
 ...
 *  Periodic pressure measurements
 */
class object : public Lwm2mObject<10269, object, instance> {
public:
...
inline bool operator== (id10269::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id10269::instance::RESID c1) { return (uint16_t) c1 == c2; }
