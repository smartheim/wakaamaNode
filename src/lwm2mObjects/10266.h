...
namespace id10266 {
/* \brief Class for object 10266 - Water Flow Readings
 ...
 *  Measures the flow of water in regular intervals
 */
class object : public Lwm2mObject<10266, object, instance> {
public:
...
inline bool operator== (id10266::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id10266::instance::RESID c1) { return (uint16_t) c1 == c2; }
