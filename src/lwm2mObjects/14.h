...
public:
    ...
    PreallocString<30> ComponentIdentity;
    
    // Optional resource
    // 1 - Software components is stored in this resource
    Opaque<30> ComponentPack;
    
    // Optional resource
    // 2 - Version of the software component.
    PreallocString<30> ComponentVersion;
...
inline bool operator== (id14::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id14::instance::RESID c1) { return (uint16_t) c1 == c2; }
