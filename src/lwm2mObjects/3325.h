...
inline bool operator== (id3325::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id3325::instance::RESID c1) { return (uint16_t) c1 == c2; }
