...
namespace id10267 {
/* \brief Class for object 10267 - Daily Maximum Flow Rate Readings
 ...
 *  Measures the maximum flow rate and its time stamp for specified period
 */
class object : public Lwm2mObject<10267, object, instance> {
public:
...
inline bool operator== (id10267::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id10267::instance::RESID c1) { return (uint16_t) c1 == c2; }
