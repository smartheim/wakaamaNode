...
namespace id10270 {
/* \brief Class for object 10270 - Battery Level Readings
 ...
 *  Periodic battery level measurements
 */
class object : public Lwm2mObject<10270, object, instance> {
public:
...
inline bool operator== (id10270::instance::RESID c1, uint16_t c2) { return (uint16_t) c1 == c2; }
inline bool operator== (uint16_t c2, id10270::instance::RESID c1) { return (uint16_t) c1 == c2; }
