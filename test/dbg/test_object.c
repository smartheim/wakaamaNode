...
OBJECT_META(test_object_instance_t, test_object_meta, test_object_write_verify_cb,
    ...
    {13, O_RES_E|O_RES_FUNCTION,0        ,  offsetof(test_object_instance_t,test_execute_fun)},

    {14, O_RES_R|O_RES_FUNCTION,O_RES_INT8,  offsetof(test_object_instance_t,test_read_fun_int8)},
    {15, O_RES_R|O_RES_FUNCTION,O_RES_UINT32,  offsetof(test_object_instance_t,test_read_fun_uint32)},
    {16, O_RES_R|O_RES_FUNCTION,O_RES_STRING,  offsetof(test_object_instance_t,test_read_fun_string)}
)
